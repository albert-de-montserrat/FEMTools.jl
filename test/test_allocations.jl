...
@testset "allocations" begin
    element_cases = (
        (LinearElement{1, 2}, (0.25,)),
        (QuadraticElement{1, 3}, (-0.2,)),
        (LinearElement{2, 3}, (0.2, 0.3)),
        (QuadraticElement{2, 6}, (0.2, 0.3)),
        (LinearElement{2, 4}, (0.2, -0.4)),
        (QuadraticElement{2, 9}, (0.2, -0.4)),
    )
