...
struct CruziexRaviart <:AbstractElement end
struct CruziexRaviartBubble <:AbstractElement end
...
function IntegrationPoints(::Union{CruziexRaviart, Type{CruziexRaviart}})
    # Integration points coordinates
...
function IntegrationPoints(::Union{CruziexRaviartBubble, Type{CruziexRaviartBubble}})
    # Integration points coordinates
    g1 = (6 - √15) / 21
    g2 = (6 + √15) / 21
    η   = SA[
...
IntegrationPoints(LinearTriangle())
IntegrationPoints(CruziexRaviart())
IntegrationPoints(CruziexRaviartBubble())