...
function main(;
    ...
    @info "Material sensitivities assembled" density_gradient_by_phase viscosity_gradient_by_phase G_gradient_by_phase K_gradient_by_phase
        ...
        if write_vtk_output
            ...
            forward_path = joinpath(out_dir, "sinking_block_forward_experimental_$step.vtk")
            sensitivity_path = joinpath(out_dir, "sinking_block_adjoint_experimental_$step.vtk")
